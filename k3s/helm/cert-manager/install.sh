...
echo "    kubectl apply -f kubernetes/k3s/helm/cert-manager/letsencrypt-http01.yaml"
echo "  For DNS-01 (private domains / wildcard):"
echo "    kubectl apply -f kubernetes/k3s/helm/cert-manager/letsencrypt-dns01.yaml"
